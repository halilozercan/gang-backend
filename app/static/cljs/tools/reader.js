...
var G__23369 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__23369;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23371 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23371,ch);
...
if(("\\" === ch__$1)){
var ch_23372__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23372__$2 == null)){
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading regex");
} else {
}

sb.append(ch_23372__$2);
} else {
}

var G__23373 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__23373;
continue;
}
}
...
var args23374 = [];
var len__23242__auto___23377 = arguments.length;
var i__23243__auto___23378 = (0);
while(true){
if((i__23243__auto___23378 < len__23242__auto___23377)){
args23374.push((arguments[i__23243__auto___23378]));

var G__23379 = (i__23243__auto___23378 + (1));
i__23243__auto___23378 = G__23379;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__22183__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__22183__auto__){
return or__22183__auto__;
} else {
var or__22183__auto____$1 = cljs.tools.reader.macros.call(null,ch);
if(cljs.core.truth_(or__22183__auto____$1)){
return or__22183__auto____$1;
} else {
return (ch == null);
}
}
...
var vec__23386 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23386,(0),null);
var start_column = cljs.core.nth.call(null,vec__23386,(1),null);
...
var G__23387 = cljs.core.conj_BANG_.call(null,a,form);
a = G__23387;
continue;
}
}
...
var _STAR_read_delim_STAR_23389 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_23389;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__23392 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23392,(0),null);
var start_column = cljs.core.nth.call(null,vec__23392,(1),null);
var the_list = cljs.tools.reader.read_delimited.call(null,")",rdr,opts,pending_forms);
var vec__23393 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23393,(0),null);
var end_column = cljs.core.nth.call(null,vec__23393,(1),null);
...
var vec__23396 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23396,(0),null);
var start_column = cljs.core.nth.call(null,vec__23396,(1),null);
var the_vector = cljs.tools.reader.read_delimited.call(null,"]",rdr,opts,pending_forms);
var vec__23397 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23397,(0),null);
var end_column = cljs.core.nth.call(null,vec__23397,(1),null);
...
var vec__23400 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23400,(0),null);
var start_column = cljs.core.nth.call(null,vec__23400,(1),null);
...
var vec__23401 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23401,(0),null);
var end_column = cljs.core.nth.call(null,vec__23401,(1),null);
...
var sb = (function (){var G__23404 = (new goog.string.StringBuffer());
G__23404.append(initch);
...
var or__22183__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Invalid number format [",s,"]");
}
} else {
var G__23406 = (function (){var G__23405 = sb;
G__23405.append(ch);

return G__23405;
})();
var G__23407 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__23406;
ch = G__23407;
continue;
}
...
switch (G__23414) {
case "\\":
var G__23418 = (function (){var G__23415 = sb;
G__23415.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23415;
})();
var G__23419 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23418;
ch = G__23419;
continue;
...
break;
default:
var G__23420 = (function (){var G__23416 = sb;
G__23416.append(ch);

return G__23416;
})();
var G__23421 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23420;
ch = G__23421;
continue;
...
var vec__23423 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23423,(0),null);
var end_column = cljs.core.nth.call(null,vec__23423,(1),null);
...
var vec__23426 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23426,(0),null);
var column = cljs.core.nth.call(null,vec__23426,(1),null);
...
var or__22183__auto__ = cljs.core.get.call(null,cljs.tools.reader._STAR_alias_map_STAR_,sym);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
var vec__23435 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23435,(0),null);
var column = cljs.core.nth.call(null,vec__23435,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__22171__auto__ = line;
if(cljs.core.truth_(and__22171__auto__)){
return cljs.core.seq_QMARK_.call(null,o);
} else {
return and__22171__auto__;
}
...
var vec__23438 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23438,(0),null);
var column = cljs.core.nth.call(null,vec__23438,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.reader_types.reader_error.call(null,rdr,"Metadata must be Symbol, Keyword, String or Map");
...
var vec__23443 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23443,(0),null);
var start_column = cljs.core.nth.call(null,vec__23443,(1),null);
var start_column__$1 = (cljs.core.truth_(start_column)?((start_column - (1)) | (0)):null);
var the_set = cljs.core.set.call(null,cljs.tools.reader.read_delimited.call(null,"}",rdr,opts,pending_forms));
var vec__23444 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23444,(0),null);
var end_column = cljs.core.nth.call(null,vec__23444,(1),null);
...
var G__23446 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23446,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_23448 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23448;
}});
...
var G__23450 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23450,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23450,rdr,first_line);

return G__23450;
} else {
var or__22183__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
var G__23455 = matched;
var G__23456 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23455;
finished = G__23456;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__22171__auto__ = opts;
if(cljs.core.truth_(and__22171__auto__)){
...
var _STAR_suppress_read_STAR_23458 = cljs.tools.reader._STAR_suppress_read_STAR_;
cljs.tools.reader._STAR_suppress_read_STAR_ = (function (){var or__22183__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_23458;
}}
} else {
return cljs.tools.reader.reader_types.reader_error.call(null,rdr,"EOF while reading character");
}
...
var arg_env23461 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23462 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23462,"(");
...
var G__23463 = (i + (1));
var G__23464 = cljs.core.conj_BANG_.call(null,args,(function (){var or__22183__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env23461;
}});
/**
...
var ch = temp__4423__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23466 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23466);
...
var G__23469 = cljs.core.next.call(null,s);
var G__23470 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23469;
key_vals = G__23470;
continue;
} else {
...
var or__22183__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
if((function (){var and__22171__auto__ = ((!((form == null)))?((((form.cljs$lang$protocol_mask$partition0$ & (262144))) || (form.cljs$core$IWithMeta$))?true:false):false);
if(and__22171__auto__){
...
))))):(cljs.core.truth_((function (){var or__22183__auto__ = (form instanceof cljs.core.Keyword);
if(or__22183__auto__){
return or__22183__auto__;
} else {
var or__22183__auto____$1 = typeof form === 'number';
if(or__22183__auto____$1){
return or__22183__auto____$1;
} else {
var or__22183__auto____$2 = typeof form === 'string';
if(or__22183__auto____$2){
return or__22183__auto____$2;
} else {
var or__22183__auto____$3 = (form == null);
if(or__22183__auto____$3){
return or__22183__auto____$3;
} else {
var or__22183__auto____$4 = cljs.tools.reader.bool_QMARK_.call(null,form);
if(cljs.core.truth_(or__22183__auto____$4)){
return or__22183__auto____$4;
} else {
...
var gensym_env23478 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env23478;
}});
...
var temp__4423__auto__ = (function (){var or__22183__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__22183__auto__)){
return or__22183__auto__;
} else {
...
var args23485 = [];
var len__23242__auto___23489 = arguments.length;
var i__23243__auto___23490 = (0);
while(true){
if((i__23243__auto___23490 < len__23242__auto___23489)){
args23485.push((arguments[i__23243__auto___23490]));

var G__23491 = (i__23243__auto___23490 + (1));
i__23243__auto___23490 = G__23491;
continue;
} else {
}
break;
...
}catch (e23488){if((e23488 instanceof Error)){
var e = e23488;
...
var args23493 = [];
var len__23242__auto___23499 = arguments.length;
var i__23243__auto___23500 = (0);
while(true){
if((i__23243__auto___23500 < len__23242__auto___23499)){
args23493.push((arguments[i__23243__auto___23500]));

var G__23501 = (i__23243__auto___23500 + (1));
i__23243__auto___23500 = G__23501;
continue;
} else {
}
break;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23496,reader){
...
var eof = cljs.core.get.call(null,map__23497__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var args23503 = [];
var len__23242__auto___23506 = arguments.length;
var i__23243__auto___23507 = (0);
while(true){
if((i__23243__auto___23507 < len__23242__auto___23506)){
args23503.push((arguments[i__23243__auto___23507]));

var G__23508 = (i__23243__auto___23507 + (1));
i__23243__auto___23507 = G__23508;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__22171__auto__ = s;
if(cljs.core.truth_(and__22171__auto__)){
return !((s === ""));
} else {
return and__22171__auto__;
