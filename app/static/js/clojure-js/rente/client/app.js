...
return (function (data,p__30595){
var vec__30596 = p__30595;
var ev_id = cljs.core.nth.call(null,vec__30596,(0),null);
var ev_data = cljs.core.nth.call(null,vec__30596,(1),null);
return ev_id;
...
cljs.core._add_method.call(null,rente.client.app.handle_event,new cljs.core.Keyword(null,"default","default",-1987822328),(function (data,p__30598){
var vec__30599 = p__30598;
var _ = cljs.core.nth.call(null,vec__30599,(0),null);
var msg = cljs.core.nth.call(null,vec__30599,(1),null);
return cljs.core.swap_BANG_.call(null,data,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"messages","messages",345434482)], null),((function (vec__30599,_,msg){
return (function (p1__30597_SHARP_){
return cljs.core.conj.call(null,p1__30597_SHARP_,msg);
});})(vec__30599,_,msg))
);
}));
