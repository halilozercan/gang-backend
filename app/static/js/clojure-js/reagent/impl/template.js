...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22584__auto__,writer__22585__auto__,opt__22586__auto__){
return cljs.core._write.call(null,writer__22585__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21986__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21986__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21986__auto__)){
return or__21986__auto__;
} else {
...
var G__29082 = o;
(G__29082[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__29084__i < G__29084__a.length) {G__29084__a[G__29084__i] = arguments[G__29084__i + 0]; ++G__29084__i;}
  args = new cljs.core.IndexedSeq(G__29084__a,0);
} 
...
var old_29086 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_29086))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_29086)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21974__auto__ = (node === document.activeElement);
if(and__21974__auto__){
var and__21974__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__21974__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__29089 = jsprops;
(G__29089["defaultValue"] = value);

(G__29089["onChange"] = ((function (G__29089,v,value,on_change){
return (function (p1__29087_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29087_SHARP_);
});})(G__29089,v,value,on_change))
);
...
var vec__29091 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29091,(0),null);
var id = cljs.core.nth.call(null,vec__29091,(1),null);
var class$ = cljs.core.nth.call(null,vec__29091,(2),null);
...
var temp__4427__auto__ = (function (){var G__29095 = cljs.core.meta.call(null,v);
var G__29095__$1 = (((G__29095 == null))?null:reagent.impl.template.get_key.call(null,G__29095));
return G__29095__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__29097_29098 = v;
var G__29097_29099__$1 = (((G__29097_29098 == null))?null:reagent.impl.template.key_from_vec.call(null,G__29097_29098));
var G__29097_29100__$2 = (((G__29097_29099__$1 == null))?null:(jsprops["key"] = G__29097_29099__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__29103 = cljs.core.meta.call(null,argv);
var G__29103__$1 = (((G__29103 == null))?null:reagent.impl.template.get_key.call(null,G__29103));
return G__29103__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__29104 = (((jsprops == null))?{}:jsprops);
(G__29104["key"] = key);
...
var G__29105 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29105;
continue;
}
} else {
...
var n__22889__auto___29106 = a.length;
var i_29107 = (0);
while(true){
if((i_29107 < n__22889__auto___29106)){
(a[i_29107] = reagent.impl.template.as_element.call(null,(a[i_29107])));
...
var a = cljs.core.into_array.call(null,s);
var n__22889__auto___29109 = a.length;
var i_29110 = (0);
while(true){
if((i_29110 < n__22889__auto___29109)){
var val_29111 = (a[i_29110]);
if((cljs.core.vector_QMARK_.call(null,val_29111)) && ((reagent.impl.template.key_from_vec.call(null,val_29111) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29110] = reagent.impl.template.as_element.call(null,val_29111));

var G__29112 = (i_29110 + (1));
i_29110 = G__29112;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__21974__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21974__auto__){
return (ctx["no-key"]);
} else {
return and__21974__auto__;
...
var G__29114 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29114) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29114){
